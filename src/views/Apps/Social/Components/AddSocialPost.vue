  ...
  <div >
    <iq-card  id="post-modal-data" body-class="iq-card iq-card-block iq-card-stretch iq-card-height" >
      <template v-slot:headerTitle >
        <h4 class="card-title">Save a life record</h4>
      </template>
      <div class="iq-card-body" v-b-modal.modal1>
        <div class="d-flex align-items-center">
            ...
            <input type="text" placeholder="Write something about the record..." class="rounded form-control" v-model="post.description" style="border:none;" />
            </form>
        </div>
        <hr />
         <ul class="post-opt-block d-flex align-items-center list-inline m-0 p-0">
            <li class="iq-bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img src="../../../../assets/images/small/07.png" alt="icon" class="img-fluid"> Photo</li>
            <li class="iq-bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img src="../../../../assets/images/small/08.png" alt="icon" class="img-fluid"> Tag Partner</li>
      ...
      <b-modal id="modal1" centered title="Save a life record" hide-footer>
          <div class="d-flex align-items-center">
            <div class="user-img">
            ...
            <b-dropdown id="dropdownMenuButton40" right variant="none" menu-class="p-0">
              ...
              <b-dropdown-item href="#" class="dropdown-item p-3">
                <div class="d-flex align-items-top">
                  ...
                  <div class="data ml-2">
                    <h6>My Network</h6>
                    <!-- <p class="mb-0">Your Network on NOMI</p> -->
                  </div>
                </div>
              </b-dropdown-item>
              <b-dropdown-item href="#" class="dropdown-item p-3">
                <div class="d-flex align-items-top">
                  <div class="d-flex align-items-top"><i class="ion-archive"></i></div>
                  <div class="data ml-2">
                    <h6>Friend expect</h6>
